    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              'build-and-deploy/pipeline/wavemaker-internal-ci-cd-pipeline/manage-deployed-apps',
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              'build-and-deploy/pipeline/external-ci-cd-pipeline/vcs/overview',
            ],
          },
          {
            type: 'category',
