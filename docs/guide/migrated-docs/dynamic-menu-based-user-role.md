...
3. [Create a DB CRUD variable](/learn/assets/var_sel.png) for the RolesActionMapping entity from the above Database and enable the *Request data on page load* property.
...
6. Create a model variable named *dynamicTree*, Type Entry and Is List property checked. Use the following structure:
