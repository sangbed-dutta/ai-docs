...
2. We have designed the canvas with a *Grid Layout* with three rows. We will have
...
3. Create a [Database CRUD Variable](./how-tos/assets/img/var_sel.png) (say, *deptVar*) using the Department table
