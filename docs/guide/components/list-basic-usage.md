...
In this step, you are expected to select a **template** and **pagination** style suitable for the current use case. For this example, we are choosing *Contact List* as the template and *Basic* as pagination style.
