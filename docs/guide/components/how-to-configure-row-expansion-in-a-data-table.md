...
*Create a department page and display employees of each department when you expand the department ID.*
...
Now, set filter criteria in the variables for *HrdbEmployeeData* to *deptId* **Is equal to** \_bind.pageParams.deptID, \_as shown in the image below:
