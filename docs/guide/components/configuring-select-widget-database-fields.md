...
2. Bind the Select widget to a database. Here we are using the Department table from the hrdb, [import the sample db](#) that comes shipped with Studio and has been imported earlier and [Create Database CRUD Variable](./how-tos/assets/img/var_sel.png) [![](./assets/img/sel_db_var.png)](./assets/img/sel_db_var.png)
