...
WaveMaker Studio is a development platform that lets you rapidly build full stack web applications using visual development for UI and configuration driven backend services
