---
title: WaveMaker Design to Code - Design to Code Figma Plugin
...
[WaveMaker Design to Code](https://www.figma.com/@wavemaker), a Figma plugin, streamlines frontend development by generating WaveMaker-compatible code directly from Figma designs using Material 3.0 and WaveMaker UI Kits.
...
Here are the steps to turn your Figma design into code using the WaveMaker Design to Code plugin:

1. **Find the Plugin** – Search for **WaveMaker Design to Code** in the **Figma Community Marketplace** or click [here](https://www.figma.com/@wavemaker).
...
4. **Run Design to Code** – Click **Run Design to Code Plugin** to start processing the selected pages.
...
Search for **WaveMaker Design to Code Plugin** and click **Run**.

![launch plugin](./assets/img/search_plugin.png)

### 3. Generate Code

Select the pages you want to process and click **Run Design to Code Plugin**. The plugin will process the selected pages.
...
1. On the Design to Code preview screen, click **Edit in WaveMaker**.
