...
#### 2. Automation: Design to Code Plugin

The Design to Code Plugin acts as the bridge between Figma and WaveMaker.\
...
1. Update the primary color token in [Style Workspace](../../user-interfaces/web/develop/styling-with-design-tokens/working-with-style-workspace).
...
Learn more about the [Design Token architecture here](../../user-interfaces/web/develop/styling-with-design-tokens/design-token-architecture).
...
:::note
Figma file → Design to Code Plugin → Edit in WaveMaker → token JSON → app UI.

Figma file → Design to Code Plugin → token JSON → app UI.\
:::
